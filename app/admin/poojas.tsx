...
const EMPTY = { temple_id: '', name: '', type: 'pooja', description: '', price: '', duration: '', image: '', scheduled_at: '' };
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: theme.colors.bg }}>
          <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
            ...
            <ScrollView contentContainerStyle={{ padding: 20, gap: 12 }}>
              ...
              <Field testID="pmg-image-input" label="Image URL" value={form.image} onChangeText={(v: string) => setForm({ ...form, image: v })} />
              <Field testID="pmg-scheduled-input" label="Scheduled At (ISO, optional)" value={form.scheduled_at || ''} onChangeText={(v: string) => setForm({ ...form, scheduled_at: v })} />
            </ScrollView>
