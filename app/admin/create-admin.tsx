...
export default function CreateAdmin() {
  ...
  const fields = [
    { key: 'full_name', label: 'Full Name', placeholder: 'e.g. Admin Name', icon: 'person-outline' as const },
    { key: 'mobile', label: 'Mobile Number', placeholder: '10-digit mobile', icon: 'call-outline' as const, keyboard: 'numeric' as const },
    { key: 'email', label: 'Email (optional)', placeholder: 'admin@example.com', icon: 'mail-outline' as const },
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.colors.bg }} edges={['top']}>
      <ScreenHeader
        ...
        gradientColors={[PURPLE, PURPLE_DEEP]}
        ...
        <ScrollView contentContainerStyle={{ padding: theme.spacing.lg, alignItems: 'center' }}>
          <ResponsiveContainer maxWidth={520}>
            ...
            <Button
              ...
              loading={saving}
              onPress={save}
              style={{ backgroundColor: PURPLE, marginTop: theme.spacing.xs }}
            />
          </ResponsiveContainer>
        </ScrollView>
...
const styles = StyleSheet.create({
  ...
  infoText: { flex: 1, color: PURPLE, fontSize: 13 },
});
